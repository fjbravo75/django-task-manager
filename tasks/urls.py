...
urlpatterns = [
    ...
    path("boards/<int:pk>/move-tasks/", board_task_move_screen, name="board_task_move_screen"),
    ...
    path("boards/<int:board_pk>/tasks/reorder/", board_task_reorder, name="board_task_reorder"),
